...
//ProjdectList Class
class ProjdectList extends Component<HTMLDivElement, HTMLElement> {
...
const activePrjList = new ProjdectList("active");
const finishedPrjList = new ProjdectList("finished");
